...
INSERT INTO selected_courses (`REGISTERED_STUDENTS_ID`, `REGISTERED_EXAM_ID`, `COURSE_CODE_TITLE_ID`)
SELECT registered_students.REGISTERED_STUDENTS_ID, 1266, '859' 
...
INSERT INTO `registered_students`( `ADMITTED_STUDENT_ID`, `REGISTERED_EXAM_ID`,`REGISTERED_STUDENTS_EXAM_ROLL`, `REGISTERED_STUDENTS_DATE`, `REGISTERED_STUDENTS_COLLEGE_VERIFY`, `REGISTERED_STUDENTS_MOFIFICATION`, `REGISTERED_STUDENTS_LATE`, `REGISTERED_STUDENTS_FORM_FILL_DATE`, `REGISTERED_STUDENTS_STATUS`) SELECT ADMITTED_STUDENT_ID,75,0,NOW(),0,0,1,NOW(),0 FROM admitted_student JOIN TMP ON admitted_student.ADMITTED_STUDENT_REG_NO = TMP.REG WHERE admitted_student.ADMITTED_STUDENT_REG_NO = TMP.REG ORDER BY TMP.id ASC;
